const TEMPAD_DATA = {
  ...
  mwb: {
    ...
    programa: [
      ...
      {tipo: "tdlb", texto: "1. ¿De qué presumirá usted?", mins: 10},
  ...
  w: {
    ...
    programa: [
      ...
      {tipo: "w",   texto: "<b>Estudio de <i>La Atalaya</i></b>: Aprendamos del “Dios de todo consuelo”", mins: 60}
    ]
  },
  ...
  w_sup: {
    ...
    programa: [
      {tipo: "tk",  texto: "<b>Discurso público</b>", mins: 30},
      {tipo: "w",   texto: "<b>Estudio de <i>La Atalaya</i></b>: Aprendamos del “Dios de todo consuelo”", mins: 30},
  ...
  CO1: {
    ...
    programa: [
      ...
      {tipo: "",   texto: "9:40 <b>DISCURSO DEL PRESIDENTE DE LA ASAMBLEA:</b> ¿Es realista la idea de ser felices para siempre?", mins: 29},
      {tipo: "",   texto: "10:10 <b>PRODUCCIÓN AUDIOVISUAL:</b> <i>Las buenas noticias según Jesús: Episodio 4<i>", mins: 29}
    ]
  },
