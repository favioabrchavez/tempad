const TEMPAD_DATA = {
  ...
  CO1: {
    ...
    programa: [
      ...
      {tipo: "extra", texto: "11:05 Canción 7 y anuncios"},
      {tipo: "CO1", texto: "11:15 SERIE DE DISCURSOS: ¡Las profecías sobre el Mesías se cumplieron!"},
      {tipo: "", texto: "• “Él mismo tomó nuestras enfermedades”"},
      {tipo: "", texto: "• “No discutirá”"},
      {tipo: "", texto: "• “Nunca les hablaba sin utilizar alguna comparación”"},
